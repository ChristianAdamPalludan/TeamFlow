...
public class Load_and_Save {
    ...
    public static void main(String[] args) {
        ...
        String p1 = "Bob,6,16,8,9";
        String p2 = "Mona,3,7,1,16";
        String p3 = "Lisa,14,5,8,3";
        String p4 = "Jack,3,3,7,13";
        String p5 = "Michael,5,3,16,3";
        String p6 = "Richard,14,7,10,8";
        Person persA = new Person("Morgan",3,6,10,13);
        ...
        System.out.println("Now printing my person object");
